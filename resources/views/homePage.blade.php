...
<html>
   ...
   <script src="bootstrap-4.0.0/dist/js/bootstrap.min.js" type="text/javascript"></script>
    ...
    <body style="margin: 0;">
	<div class="violent">
    <a href="Homea"  style="float:right;margin:10px;font-size:20px;color:white">
        <img src="../img/eg.png" width="30" height="20">
    </a>
  ...
  <i style="padding:15px 10px;background-color: white;border-radius: 180px;margin-right: 3px;color: darkviolet;font-size: 20px">KFS </i>University</p>
		<div class="list">
                    <a href="Professor" class="one"><div>Professor</div></a>
                    <a href="r" class="one"><div>Student</div></a>
		</div>
		<div class="text">
                    <p>
