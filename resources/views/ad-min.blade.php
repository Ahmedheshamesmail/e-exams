...
<html>
    ...
    <a href="Professor" style="position: absolute;right: 50px;top: 10px;">
        <button class="btn btn-block">Sign Up</button>
    </a>
    <hr>
    <center style="padding-top: 20vh">
        <form style="padding: 15px;height: auto;width: 280px;background-color: white;box-shadow: -5px 2px 20px 2px gray;border-radius: 20px;" action="Login-P" method="post" class="pure-form pure-form-stacked">
            {{csrf_field()}}
            <legend class="text-primary">Login <i class="fas fa-user"></i> </legend>
