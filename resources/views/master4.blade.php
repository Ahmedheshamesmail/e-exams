...
<head>
    ...
    <link href="../css/admain4.css" rel="stylesheet" type="text/css"/>
    ...
    <center>
        ...
        <div class="container">
			...
			<ul>
                ...
                <a href="../LogOut" class="conx2log" style="margin-top:-3vh"> <i class="fas fa-sign-out-alt x2log"></i></a>
            </div>
        </div>
        <div class="nav-links d-flex flex-column justify-content-between align-content-between align-items-center">
            ...
            <ul class="d-flex flex-column justify-content-between align-content-between align-items-center">
                ...
                <div class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown">
                        <i class="fas fa-list" style="font-size: 20px;margin-right: 7px;"></i>Level
                    </a>
			...
			<ul>
                ...
                <div class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown">
                        <i class="fas fa-clock" style="font-size: 20px;margin-right: 7px;"></i> Exam Time
                    </a>
                   <div class="dropdown-menu" style="height: 27vh">
			<ul>
                            @foreach($rowl as $y)
