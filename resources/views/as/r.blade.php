...
<body style="background-image: url('img/l.jpg');background-position: center;background-size: cover;background-repeat: no-repeat;position: relative">
    <a href="Student-SignUpa" style="display: block;cursor: pointer; margin: 10px ">
    ...
    <center>
        ...
        <div class="container v-d">
            <div class="row flex-row justify-content-center align-content-between align-items-center col-md-5 col-12 pd">
                    ان قمت بالتسجيل من قبل فحاول الدخول عن طريق الرقم القومي المسجل به
                    <br><br>

                        <button style="margin-right: 20px;color :#52334a" class="btn tog">
                           تسجيل الدخول بواسطة الرقم القومي
                        </button>

                </div>
            </div>
        <form action="stuv2a" method="post" class="form2 animated">
                                    {{csrf_field()}}
                                    <input type="text" name="nat"  value="{{old('nat')}}"  class="form-control" placeholder="الرقم القومي">
                                    <br>
                                    <center><input type="submit" class="btn" style="background-color: #471c38;color: white" value="دخول"></center>
                                </form>
    </center>
...
<section>
    ...
    <div class="container"  style="overflow: hidden">
        ...
        <div class="row flex-row justify-content-between align-content-center align-items-center flex-wrap"  style="overflow: hidden">
            ...
            <form  action="stuva" method="post" class="form1">
                {{csrf_field()}}
	...
	c0.7,0.9,0.6,2.1-0.3,2.8l-1.7,1.5C148.2,64.9,145.7,61.9,145.7,61.9z"/>
		...
		c-0.7,0.9-0.6,2.1,0.3,2.8l1.7,1.5C240.3,63.9,242.8,60.9,242.8,60.9z"/>
                ...
                <div class="inputGroup inputGroup1">
                    <label for="email">الرقم الجامعي</label>
                    <input type="text" id="email" name="nid" value="{{old('email')}}" class="email" maxlength="256"/>
                ...
                <div class="inputGroup inputGroup3">
                    <button id="login" type="submit">دخول</button>
                </div>
            </form>
