    ...
    <div class="container">
        <div class="row flex-row justify-content-between align-content-center align-items-center flex-wrap" style="padding-top: 5vh">
            @foreach($row as $x)
                    ...
                    @endforeach
                @endforeach
            <form action="Updated-Imagea" method="post" enctype="multipart/form-data" style="margin-top: 8vh">
                {{csrf_field()}}
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="basic-addon3">اختر صوره</span>
                    </div>
                ...
                @if($x->admin == 0)
                    <a href="Profilea">
                        <input type="button" class="btn btn-block" value="إلغاء">
                    </a>
                @endif
                @if($x->admin == 1)
                    <a href="A-Pagea">
