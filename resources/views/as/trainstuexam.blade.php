    ...
    <section style="width: 100%;">
        <div class="container">
            <div class="row flex-row justify-content-center align-content-center align-items-center flex-wrap" style="padding-top:  5vh;color: black">
                <form action="endtraina" method="post" enctype="multipart/form-data" style="width: 100%">
                    {{csrf_field()}}
                                            ...
                                            @if($at->question_id == $q->id)
                                                ...
                                                @if($at->fileattache_id == 2)<br><br>
                                                            <audio controls loop preload="auto" style="outline:0;">
                                                                ...
                                                                المتصفح الخاص بك لا يدعم ملفات الصوت                                                            </video>
                                                            </audio>
                                                @endif
                                                @if($at->fileattache_id == 3)<br><br>
                                                            <video controls>
                                                                ...
                                                                المتصفح الخاص بك لا يدعم ملفات الفديو                                                            </video>
                                                            </video>
                                                @endif
                                            @endif
                                        @endif
                                            ...
                                            @if($at->question_id == $q->id)
                                                @if($at->fileattache_id == 1)<br><br>
                                                            ...
                                                            <audio controls loop preload="auto" style="outline:0;" class="col-12">
                                                                <source src="../att/audio/{{$at->name}}" type="audio/mpeg">
                                                                <source src="../att/audio/{{$at->name}}" type="audio/ogg">
المتصفح الخاص بك لا يدعم ملفات الصوت                                                            </audio>
                                                @endif
                                                @if($at->fileattache_id == 3)<br><br>
...
المتصفح الخاص بك لا يدعم ملفات الفديو                                                            </video>
                ...
                <div class="d-flex justify-content-center align-items-center">
                    <input type="submit" class="btn btn-outline-success col-3" value="إنهاء الامتحان" style="margin-right: 15px;margin-left: 15px;">
                    <a href="Endiniga" class="col-3">
                        <input type="button" class="btn btn-danger" value="إلغاء">
                    </a>
                </div>
                    <br><br>
               </form>
